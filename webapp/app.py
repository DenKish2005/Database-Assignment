...
MODELS = {
    ...
    "job_application": (JobApplication, None),  # composite PK special-case
}

# Fields to show/edit per model
FIELDS = {
...
def create_tables_once():
    # Ensures tables exist. Part 1 is still the "real" creation.
...
def edit_item(model_name, pk_value):
    ...
    if pk is None:
        abort(400)  # composite pk handled separately
